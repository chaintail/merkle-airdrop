...
export const RPC_CHAIN_NAMES: Record<number, string> = {  
  ...
  [chains.shibarium.id]: "shib-mainnet",
  [chains.shibariumTestnet.id]: "shib-testnet",
};
...
export const NETWORKS_EXTRA_DATA: Record<string, ChainAttributes> = {
  ...
  [chains.shibarium.id]: {
    color: "#32CD32",
    nativeCurrencyTokenAddress: "0x9813037ee2218799597d83d4a5b6f3b6778218d9", //BONE
  },
  [chains.shibariumTestnet.id]: {
    color: "#32CD32",
    nativeCurrencyTokenAddress: "0xcA94c8B16209CCBAfCFeab9D7649DdaEcD444007", //BONE
  },
  [chains.polygon.id]: {
    // color: "#2bbdf7",
    color: "#800080",
    nativeCurrencyTokenAddress: "0x7D1AfA7B718fb893dB30A3aBc0Cfc608AaCfeBB0", //MATIC
  },
